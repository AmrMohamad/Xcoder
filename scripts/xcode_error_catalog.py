...
ERROR_RECOVERY: dict[str, dict[str, Any]] = {
    ...
    "xcode_menu_action_blocked": {"recovery": "user_input", "transient": False, "retry_after_seconds": None},
    "xcode_menu_item_not_found": {"recovery": "environment", "transient": False, "retry_after_seconds": None},
    "xcode_menu_item_disabled": {"recovery": "user_input", "transient": False, "retry_after_seconds": None},
    ...
    "cache_identity_mismatch": {"recovery": "environment", "transient": False, "retry_after_seconds": None},
    "cache_metadata_corrupt": {"recovery": "environment", "transient": False, "retry_after_seconds": None},
    "cache_lock_timeout": {"recovery": "retry", "transient": True, "retry_after_seconds": 2},
    "xcode_busy": {"recovery": "retry", "transient": True, "retry_after_seconds": 2},
    "queue_timeout": {"recovery": "retry", "transient": True, "retry_after_seconds": 2},
    "workflow_prerequisite_failed": {"recovery": "permanent", "transient": False, "retry_after_seconds": None},
    "run_not_verified": {"recovery": "environment", "transient": False, "retry_after_seconds": None},
    "configuration_not_supported": {"recovery": "user_input", "transient": False, "retry_after_seconds": None},
    "package_spec_violation": {"recovery": "permanent", "transient": False, "retry_after_seconds": None},
    "package_integrity_failed": {"recovery": "permanent", "transient": False, "retry_after_seconds": None},
    "package_provenance_mismatch": {"recovery": "permanent", "transient": False, "retry_after_seconds": None},
    "release_source_dirty": {"recovery": "user_input", "transient": False, "retry_after_seconds": None},
    "binary_self_test_failed": {"recovery": "environment", "transient": False, "retry_after_seconds": None},
    "export_options_invalid": {"recovery": "user_input", "transient": False, "retry_after_seconds": None},
    "xcode_distribution_requires_gui": {"recovery": "implementation_needed", "transient": False, "retry_after_seconds": None},
    "signing_preflight_failed": {"recovery": "user_input", "transient": False, "retry_after_seconds": None},
    "upload_failed": {"recovery": "retry", "transient": True, "retry_after_seconds": 30},
